"""
Django settings for ratoapi project.
...
WSGI_APPLICATION = "ratoapi.wsgi.application"
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "ratoapi.authentication.ExpiringTokenAuthentication",
        "rest_framework.authentication.SessionAuthentication",
    ],
    "DEFAULT_PERMISSION_CLASSES": [
        "ratoapi.permissions.StrictDjangoObjectPermissions",
    ],
